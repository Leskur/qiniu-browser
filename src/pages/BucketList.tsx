                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button 
                        onClick={(e) => { e.stopPropagation(); setBucketToDelete(bucket.tbl); setDeleteConfirmInput(""); }}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-zinc-900 w-full max-w-sm rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden p-6 text-center">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
              删除后该空间内所有文件将永久丢失，且无法恢复。请输入空间名称 <strong className="text-red-500 select-all">{bucketToDelete}</strong> 以确认。
            </p>
            <input
              type="text"
              autoFocus
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' && deleteConfirmInput === bucketToDelete) executeDelete(bucketToDelete);
                if (e.key === 'Escape') { setBucketToDelete(null); setDeleteConfirmInput(""); }
              }}
            ...
            <div className="flex flex-col gap-2">
              <button 
                ...
                disabled={deleteConfirmInput !== bucketToDelete}
              ...
              <button 
                onClick={() => { setBucketToDelete(null); setDeleteConfirmInput(""); }}
